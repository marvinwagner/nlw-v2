...
final class HomeViewController: UIViewController, UITextFieldDelegate {
    ...
    func configureToolBar() {
        ...
        toolBar.sizeToFit()
        let button = UIBarButtonItem(title: "Done", style: .plain, target: self, action: #selector(self.actionCity))
    ...
    @IBAction func enterPressed(_ sender: UIButton) {
        self.performSegue(withIdentifier: K.segueGoToPoint, sender: self)
    }
}
